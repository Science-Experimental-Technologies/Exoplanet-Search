...
def check(wheel: Path) -> None:
    with ZipFile(wheel) as archive:
        ...
        for required in ("src/__init__.py", "src/cli.py", "src/doctor.py", "src/config_check.py", "src/workspace.py", "src/workspace_status.py", "src/pipeline.py", "src/default_configs/base.yaml",
