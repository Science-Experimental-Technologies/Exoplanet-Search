...
The frozen candidate screening shortlist contains 20 signals on 14 unique Kepler targets. Independent vetting assigns **0 strong**, **1 weak**, and **19 likely false-positive** labels.
...
No signal meets the deliberately strict `strong_candidate` rule; subsequent publication must not imply otherwise.
