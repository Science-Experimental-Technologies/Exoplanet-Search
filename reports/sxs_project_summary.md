...
## Catalog boundary and research record

Operational candidate scores were separated from benchmark estimates. Catalog matches, official false-positive membership, and unmatched signals were recorded without treating catalog absence as validation. Workflow reports, confusion matrices, metrics, and the research draft established the first complete SXS research record.
...
- `output/pdf/sxs_preprint_v1.0.0.pdf` - visually verified preprint PDF
- `reports/independent_validation.md` - complete independent-vetting record
